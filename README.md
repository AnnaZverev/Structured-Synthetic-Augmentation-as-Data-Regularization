...
This repository contains the code used to reproduce the main experimental pipeline and the **rebuttal-grade cross-domain generalization stress-tests** for binary anomaly classification in spatio-temporal data.
...
- `rebuttal_results.csv` — aggregated results table (generated by the notebook)
- `figures/` or `outputs/` — plots and intermediate outputs (generated)
